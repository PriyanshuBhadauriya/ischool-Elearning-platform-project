...
if(isset($_REQUEST['submitFeedbackBtn'])){
	...
	else
	{
		...
		if($conn->query($sql) == TRUE ){
			...
			role="alert">Sumbitted Successfully </div>';
		}
		else
			{
...
<div class="col-sm-6 mt-5">
	<form class="mx-5" method="POST" enctype="multipart/form-data">
		<div class="form-group">
			...
			<input type="text" name="form-control" id="stuId" name="stuId" value="<?php if(isset($stuId)) {echo $stuId;}?>"readonly>
		</div>
		<div class="form-group">
			<label for="f_content">Write Feedback</label>
			<textarea type="text" name="form-control" id="f_content" name="f_content" row=2></textarea>
		</div>
